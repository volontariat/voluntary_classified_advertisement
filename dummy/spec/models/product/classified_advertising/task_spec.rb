...
describe Product::ClassifiedAdvertising::Task do
  describe 'validations' do
    describe '#at_least_one_vacancy' do
      before :each do
        subject = FactoryGirl.build(:classified_advertising_task)
      ...
      context 'task with vacancy' do  
        it 'is valid' do
          subject.vacancies << FactoryGirl.build(:classified_advertising_vacancy, task: subject)
          subject.valid?
  ...
  describe '#vacancies_attributes=' do
    it 'creates, updates and destroys vacancies' do
      ...
      subject = FactoryGirl.build(:classified_advertising_task, story: project.stories.first)
